...
const CompassLargeIcon = React.forwardRef(({ title, titleId, ...props }, ref) => (
...
<path d="M13.5 12C13.5 12.8284 12.8284 13.5 12 13.5C11.1716 13.5 10.5 12.8284 10.5 12C10.5 11.1716 11.1716 10.5 12 10.5C12.8284 10.5 13.5 11.1716 13.5 12Z" fill="black" fill-opacity="0.56"/>
</svg>

));

export default CompassLargeIcon;
