...
const DishwasherMachineOIcon = React.forwardRef(({ title, titleId, ...props }, ref) => (
...
<path d="M12.75 7.75C13.1642 7.75 13.5 7.41421 13.5 7C13.5 6.58579 13.1642 6.25 12.75 6.25C12.3358 6.25 12 6.58579 12 7C12 7.41421 12.3358 7.75 12.75 7.75Z" fill="black" fill-opacity="0.56"/>
...
<path d="M14.01 11.0098C12.36 11.0098 11.02 12.3498 11.02 13.9998C11.02 15.6498 12.35 16.9898 14.01 16.9898C15.67 16.9898 17 15.6498 17 13.9998C17 12.3498 15.66 11.0098 14.01 11.0098Z" fill="black" fill-opacity="0.56"/>
</svg>

));

export default DishwasherMachineOIcon;
