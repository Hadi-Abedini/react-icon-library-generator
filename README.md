...
- `src/icons/iconPack/`: این پوشه به صورت خودکار توسط اسکریپت ساخته و مدیریت می‌شود. **از تغییر دستی فایل‌های این پوشه خودداری کنید.**
...
پس از اجرای موفقیت‌آمیز، تمام کامپوننت‌های جدید در پوشه `src/icons/iconPack` ساخته می‌شوند.
